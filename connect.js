...
sabrina.sendMessage(mdata_2.id, {image: {url:`https://yoshinofenixbots.online/welcome?titulo=BEM%20VINDO(A)&nome=${sab2.participants[0].split('@')[0]}&perfil=${shortpc.data}&fundo=${fundo1}&grupo=BEM VINDO AO GRUPO ${encodeURI(mdata_2.subject)}`},
...
sabrina.sendMessage(mdata_2.id, {image: {url:`https://yoshinofenixbots.online/welcome?titulo=Adeus&nome=${sab2.participants[0].split('@')[0]}&perfil=${shortpc.data}&fundo=${fundo2}&grupo=SAIU DE ${encodeURI(mdata_2.subject)}`}, caption: teks, 
...
console.log(colors.green(`〔 YOSHINO 3.0 _ - CONECTADA COM SUCESSO... 〕`))
