...
sabrina.groupLeave(rg_alg_ofc.grupo)
horadd = parseInt(dat_rg.split("/")[1])+1;
txt = `Só passando pra avisar que o aluguel do grupo *${rg_alg_ofc.nome_do_gp}*, encerrou hoje, entre em contato com indivíduo para efetuar a cobrança.\n–\n• Texto registrado por você sobre o criador do grupo: *${rg_alg_ofc.texto}*`;
...
module.exports = { PhoneNumber, P, fs, util, Boom, axios, linkfy, request, ms, ffmpeg, fetch, qrterminal, exec, spawn, yts, execSync, limitefll, moment, time, hora, date, infoSystem, RSM_FUNC, addVote, delVote, getBuffer, convertSticker, fetchJson, fetchText, getBase64, createExif, writeExifImg, addLimit, getLimit, upload, nit, addBanned, unBanned, BannedExpired, cekBannedUser, validmove, setGame, addComandosId, deleteComandos, getComandoBlock, getComandos, addComandos, palavrasANA, quizanimais, getpc, supre, wait, getExtension, generateMessageID, getGroupAdmins, getMembros, getRandom, banner, banner2, banner3, temporizador, chyt, webp_mp4, simih, antispam, anotar, rg_aluguel, voting, sotoy, addVote, delVote, countMessage, comandos, daily, muted, nescessario, premium, ban, black_, joguinhodavelhajs, joguinhodavelhajs2, setting, logoslink, linguagem, getInfo, mess, destrava, destrava2, tabela, conselhob, fatos, palavrasc, recognize, colors, cheerio, NodeCache, kyun, sendVideoAsSticker, sendImageAsSticker, sendVideoAsSticker2,sendImageAsSticker2, enviarfiguUrl, sendPoll, getFileBuffer, DLT_FL, sleep, ANT_LTR_MD_EMJ, convertBytes, arcloud, EmojiAPI, emoji, infoClima, os, garticArchives, enigmaArchive, insert, response, randomCantadas, isFiltered, addFilter, mines, getMinesPositions, MinesHelp, psycatgames, MultiDownload, AssemblyAI, sabrpg, bcbet, rgtake, piadas, whatMusicAr, level2 }